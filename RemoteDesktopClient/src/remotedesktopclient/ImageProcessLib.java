...
public class ImageProcessLib {
    ...
    public static BufferedImage captureScreen(Robot robot, Rectangle imageShape) throws IOException {
        BufferedImage image = robot.createScreenCapture(imageShape);
        //Graphics2D graphic = (Graphics2D) image.getGraphics();
        //graphic.drawImage(ImageIO.read(new File("pointer.png")), xPos, yPos, null);
        return image;
    }
